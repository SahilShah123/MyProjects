    ...
    <div style="width:495px;height:325px">
       ...
       <div style="float:left;width:290px;height:198px;border:1px solid white">
            ...
            Quantity: <select style="width:100px;" id="quant"><% for(int k=1;k<=quantity;k++){%><option ><%=k%></option><%}%></select><br /><br />
             &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="button" id="cart" style="background-image:url(../vantage/images/Untitled.png);height:35px;width:90px;margin:20px 50px;" />
        </div>
...
%>
 <div id="div-avatar" style="margin-left:120px;width:295px;background-image:url(../vantage/css/images/dressing-room-bg.png)">
